...
Запросов в секунду (RPS) составляет >120 тыс./сек. [[4]](#источники).  
Также средний размер одного чека — `60 КБ = 61440 байт`.

Тогда объём данных в секунду:  
`120000 запросов/с * 61440 байт = 7372800000 байт/с ≈ 58.98 Гбит/с` — пиковое потребление.

Суммарный суточный объём данных:  
`7372800000 байт/с * 86400 сек = 637009920000000 байт ≈ 637010 ГБ/сутки ≈ 637 ТБ/сутки`.
...
Пусть Пиковый RPS равен тройному среднему RPS.
