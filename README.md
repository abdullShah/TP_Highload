...
`accounts` | Пусть минимум один счет у клиента: [110 млн](#продуктовые-метрики) * 165 байт = **17 ГБ**
...
`receipts` | Если не создавать для каждой транзакции чек, то пусть коэфф. создания будет равен 2 раз к 14 дням, то объем равен: 5 чека месяц * 12 месяцев * 34 года * 84.4 млн * 120 байт = **19 ТБ**
