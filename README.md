...
Все остальная функциональность будет идти на основной домен. 
...
**Вывод:** Для покрытия нагрузки достаточно разместить ДЦ в ключевых городах:
- Москва (Центральный регион),
- СПб (Северо-Западный регион),
...
| Город | Москва | Санкт-Петербург | Екатеринбург | Новосибирск | Казань | Ростов-на-Дону |
|-----------|--------|------------------|--------------|-------------|--------|----------------|
| Москва | - | 16 | 22 | 39 | 17 | 19 |
| Санкт-Петербург | 16 | - | 28 | 39 | 23 | 25 |
...
Для глобальной балансировки нагрузки предпочтительна DNS-балансировка как оптимальное решение для российского трафика, ведь:
- 95% пользователей находятся в России,
- прямые задержки между ДЦ ([таблица связи между ДЦ](#расчет-примерной-задержки-связи-между-дц-мс)) не больше 40 мс., соответственно Anycast излишен.

**Правила маршрутизации:**
- Пользователи из Центральной России -> Московский ДЦ
- Пользователи из СЗР -> Санкт-Петербургский ДЦ
- Пользователи с Урала -> Екатеринбургский ДЦ
- Пользователи из Сибири -> Новосибирский ДЦ
- Пользователи из Поволжья -> Казанский ДЦ
- Пользователи с Юга России -> Ростовский ДЦ
